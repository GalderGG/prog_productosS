        ...
        <input type="hidden" name="id" value="${producto.getId()}">
          ...
          <div class="mb-3">
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="fechaCompra" name="fechaCompra" value="${producto.getFecha_compra()}">
            </div>
          </div>
          <div class="mb-3">
            <div class="form-group">
              <label for="color">Color</label>
              <input type="color" class="form-control" id="color" name="color" value="${producto.getColor()}">
            </div>
          </div>
          <div class="mb-3">
            <div class="form-group">
          ...
          <div class="mb-3">
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="precio" name="precio" placeholder="1.00" step="0.01" value="${producto.getPrecio()}">
            </div>
          </div>
          <div class="mb-3">Descuento
